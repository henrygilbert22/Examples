...
int main( )
{
    ...
    int begin = 0;
    int sub = longestSubseq_Cubic<int>(v1, 30, 20, &begin);
    cout << "Cubic func found "<< sub << " items:";
	cout<< "start pos: " <<begin<<endl;
    ...
    begin = 0;
    sub = longestSubseq_Quad <int>(v1, 30, 20, &begin);
    ...
    begin = 0;
    sub = longestSubseq_Linear<int>(v1, 30, 20, &begin);
